...
oracleDriver <- JDBC("oracle.jdbc.OracleDriver", classPath="C:/Users/user/bigdataproject/statisticR/lib/ojdbc6.jar", " ")
...
cp = c("C:/Users/user/bigdataproject/statisticR/lib/hive-jdbc.jar",
	"C:/Users/user/bigdataproject/statisticR/lib/hadoop-common.jar",
	"C:/Users/user/bigdataproject/statisticR/lib/libthrift-0.9.2.jar",
	"C:/Users/user/bigdataproject/statisticR/lib/hive-service.jar",
	"C:/Users/user/bigdataproject/statisticR/lib/httpclient-4.2.5.jar",
	"C:/Users/user/bigdataproject/statisticR/lib/httpcore-4.2.5.jar",
	"C:/Users/user/bigdataproject/statisticR/lib/hive-jdbc-standalone.jar")
.jinit(classpath=cp)
.jclassPath()

hiveDriver <- JDBC("org.apache.hive.jdbc.HiveDriver", "C:/Users/user/bigdataproject/statisticR/lib/hive-jdbc.jar", identifier.quote="`")
